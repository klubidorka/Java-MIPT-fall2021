...
import static template_method.report_sender.LatencySimulator.*;

public class MobileReportSender extends ReportSender {
    public MobileReportSender(String login, String password) {
